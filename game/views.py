    ...
    def get_context_data(self, **kwargs):
        ...
        if login:
            ...
            if user_request['response']:
                # 76561198071620586
                # проверка, если введен id пользователя вместо логина
                userid = user_request['data'] if user_request['data'] else login
                ...
                if games_list:
                    ...
                    context['error'] = "Пользователь не найден, либо игровые данные недоступны"
            else:
